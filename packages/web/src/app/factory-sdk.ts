...
function SdkProviderFactory() {
  this.create = (urlOptionName): Provider => (
     {
      ...
      useFactory: async (configService: ConfigService) => {
        ...
        const sdk = new Sdk({
          signer,
          chainWsUrl: configService.get(urlOptionName),
...
export const sdkProviderFactoryInstance = new SdkProviderFactory();
